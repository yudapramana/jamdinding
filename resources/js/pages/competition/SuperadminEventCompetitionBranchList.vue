            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-sm text-muted mb-0">
                        Pengaturan cabang/golongan yang aktif pada setiap event MTQ.
                    </p>
                </div>
                <button
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-4 mb-2 mb-md-0">
                            <label class="mb-1 text-sm text-muted">Pilih Event</label>
                            <select
                            ...
                            >
                                ...
                                <option
                                    ...
                                    :value="ev.id"
                                >
                                    {{ ev.nama_event || ev.name }} ({{ ev.nama_aplikasi || ev.app_name || 'e-MTQ' }})
                                </option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-2 mb-md-0">
                            <label class="mb-1 text-sm text-muted">Pencarian</label>
                            <input
                                v-model="search"
                                type="text"
                                class="form-control form-control-sm"
                                placeholder="Cari kode, nama cabang/golongan..."
                                :disabled="!selectedEventId"
                            />
                        </div>
                        <div class="col-md-4 text-md-right mt-2 mt-md-0">
                            <span class="text-muted text-sm" v-if="selectedEventId">
                                Total: <strong>{{ meta.total || 0 }}</strong> cabang
                            </span>
                            <span class="text-muted text-sm" v-else>
                                Pilih event untuk melihat cabang.
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Pagination -->
                <div class="card-footer clearfix" v-if="selectedEventId">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <form @submit.prevent="submitForm">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- Info relasi master (read-only bila diisi) -->
                                    <div class="form-group mb-0">
                                        <label class="mb-1 text-sm text-muted">Info Template Master (opsional)</label>
...
const fetchEvents = async () => {
  try {
    // asumsi sudah ada endpoint events v1
    const res = await axios.get('/api/v1/events', {
      params: { per_page: 999 },
    })
    const paginated = res.data.data
    eventOptions.value = paginated.data || []
  } catch (error) {
...
// re-fetch jika event atau search berubah
watch(
